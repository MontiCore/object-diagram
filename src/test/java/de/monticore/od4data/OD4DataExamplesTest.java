  ...
  public void disableFailQuick() {
    ...
    TypeSymbol typeOfObject =
        OD4DataMill.typeSymbolBuilder().setName("TypeOfObject").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol type1 = OD4DataMill.typeSymbolBuilder().setName("type1").setEnclosingScope(gs)
        .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol allData = OD4DataMill.typeSymbolBuilder().setName("AllData").setEnclosingScope(gs)
        .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol innerObjectType =
        OD4DataMill.typeSymbolBuilder().setName("InnerObjectType").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol javaSourceFile =
        OD4DataMill.typeSymbolBuilder().setName("JavaSourceFile").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol type3 = OD4DataMill.typeSymbolBuilder().setName("type3").setEnclosingScope(gs)
        .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol objectType2 =
        OD4DataMill.typeSymbolBuilder().setName("ObjectType2").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol directory =
        OD4DataMill.typeSymbolBuilder().setName("Directory").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol myObject = OD4DataMill.typeSymbolBuilder().setName("MyObject").setEnclosingScope(gs)
        .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol javaClassType =
        OD4DataMill.typeSymbolBuilder().setName("JavaClassType").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    gs.add(auction);
    gs.add(person);
    gs.add(string);
