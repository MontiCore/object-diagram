...
public class OD4DataTestUtil {
  ...
  public static ASTODArtifact loadModel(Path pathToArtifact, MCPath symbolPath) {
    ...
    ASTODArtifact artifact = OD4DataToolAPI.parse(pathToArtifact.toString());
    if (artifact == null) {
  ...
  public static IOD4DataArtifactScope createSymbolTableFromAST(ASTODArtifact ast) {
    IOD4DataArtifactScope as = OD4DataToolAPI.createSymbolTable(ast, true);
