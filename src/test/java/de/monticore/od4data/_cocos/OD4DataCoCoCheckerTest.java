...
public class OD4DataCoCoCheckerTest {
  ...
  public void setup() {
    ...
    TypeSymbol objectType1 =
        OD4DataMill.typeSymbolBuilder().setName("ObjectType1").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol objectType2 =
        OD4DataMill.typeSymbolBuilder().setName("ObjectType2").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol objectType3 =
        OD4DataMill.typeSymbolBuilder().setName("ObjectType3").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol objectType4 =
        OD4DataMill.typeSymbolBuilder().setName("ObjectType4").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    TypeSymbol objectType5 =
        OD4DataMill.typeSymbolBuilder().setName("ObjectType5").setEnclosingScope(gs)
            .setSpannedScope(OD4DataMill.scope()).build();
    gs.add(objectType);
    gs.add(objectType1);
    gs.add(objectType2);
