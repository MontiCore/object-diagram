...
public class OD4ReportToolAggregationTest {
  ...
  public void testOD4ReportSymboltypesTOGS() {
    ...
    String[] input_2 =
        { "-i", "src/test/resources/symboltable/aggregation/TestOD.od", "-symboltypes",
            symtypes_args, "-path", "src/test/resources/symboltable/aggregation/cd" };
