...
/**
 * Base class initializing the individual pretty printers. Must override the visitors, handlers for
 * each individual pretty printer
 */
public class PlantUMLODFullPrettyPrinter {
  ...
  public PlantUMLODFullPrettyPrinter() {
    ...
    MCCommonLiteralsPrettyPrinter literalsPrettyPrinter =
    ...
    PlantUMLODBasisPrettyPrinter plantUmlOdBasisPrettyPrinter =
        new PlantUMLODBasisPrettyPrinter(printer);
    traverser.add4ODBasis(plantUmlOdBasisPrettyPrinter);
    traverser.setODBasisHandler(plantUmlOdBasisPrettyPrinter);
    PlantUMLODLinkPrettyPrinter plantUmlOdLinkPrettyPrinter =
        new PlantUMLODLinkPrettyPrinter(printer);
    traverser.add4ODLink(plantUmlOdLinkPrettyPrinter);
    traverser.setODLinkHandler(plantUmlOdLinkPrettyPrinter);
    PlantUMLODReportPrettyPrinter plantUMLODReportPrettyPrinter =
        new PlantUMLODReportPrettyPrinter(printer);
