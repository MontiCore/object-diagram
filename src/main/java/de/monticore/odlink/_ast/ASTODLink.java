...
public class ASTODLink extends ASTODLinkTOP {
  ...
  public ArrayList<String> getLeftReferenceNames() {
    ...
    getODLinkLeftSide().getReferenceNamesList()
        .forEach(astodName -> leftNames.add(astodName.getName()));
    return leftNames;
  }
  ...
  public ArrayList<String> getRightReferenceNames() {
    ...
    getODLinkRightSide().getReferenceNamesList()
        .forEach(astodName -> rightNames.add(astodName.getName()));
    return rightNames;
  }
