...
import de.monticore.odbasics._visitor.ODBasicsVisitor;
...
public class ODBasicsPrettyPrinter extends MCBasicTypesPrettyPrinter implements ODBasicsVisitor {
  ...
  /**
   * @see de.monticore.odbasics._visitor.ODBasicsVisitor#handle(de.monticore.odbasics._ast.ASTODValue)
   */
  @Override
  ...
  /**
   * @see de.monticore.odbasics._visitor.ODBasicsVisitor#handle(de.monticore.odbasics._ast.ASTODName)
   */
  @Override
  ...
  /**
   * @see de.monticore.odbasics._visitor.ODBasicsVisitor#handle(de.monticore.odbasics._ast.ASTODLiteral)
   */
  @Override
  ...
  /**
   * @see de.monticore.odbasics._visitor.ODBasicsVisitor#handle(de.monticore.odbasics._ast.ASTODAbsent)
   */
  @Override
  ...
  /**
   * @see de.monticore.odbasics._visitor.ODBasicsVisitor#setRealThis(de.monticore.odbasics._visitor.ODBasicsVisitor)
   */
  @Override
  ...
  /**
   * @see de.monticore.odbasics._visitor.ODBasicsVisitor#getRealThis()
   */
  @Override
