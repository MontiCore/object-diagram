...
package de.monticore.od4development.types3;
...
/**
 * TypeCheck3 implementation for the OD4Development language.
 * After calling {@link #init()},
 * this implementation will be available through the TypeCheck3 interface.
 */
public class OD4DevelopmentTypeCheck3 extends MapBasedTypeCheck3 {
  ...
  protected static void initTC3Delegate() {
    Log.trace("init OD4DevelopmentTypeCheck3", "TypeCheck setup");
    ...
    // create delegate
    OD4DevelopmentTypeCheck3 oclTC3 = new OD4DevelopmentTypeCheck3(traverser, type4Ast, ctx4Ast);
    oclTC3.setThisAsDelegate();
  }
  
  protected OD4DevelopmentTypeCheck3(ITraverser typeTraverser, Type4Ast type4Ast,
