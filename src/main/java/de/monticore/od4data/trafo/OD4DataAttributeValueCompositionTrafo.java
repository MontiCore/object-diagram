...
public class OD4DataAttributeValueCompositionTrafo {
  
  protected OD4DataTraverser traverser;
  
  public OD4DataAttributeValueCompositionTrafo() {
  ...
  public static void init(OD4DataTraverser traverser) {
    final OD4DataAttributeValueCompositionTrafoExtension trafo =
        new OD4DataAttributeValueCompositionTrafoExtension();
